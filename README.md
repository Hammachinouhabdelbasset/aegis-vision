...
aegis-main: -backend calculates and does the processing using the process_frame() function
-frontend recieves data via websocket and displays the data on a live dashboard
